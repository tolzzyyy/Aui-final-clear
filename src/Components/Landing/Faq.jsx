  ...
  const accordions = [
    {
      ...
      content:
        "You can sign up using your matric number, university email, and a secure password on the login page.",
    },
    {
      id: 2,
    ...
    {
      id: 3,
      title: "Can I track my clearance progress?",
      content: "Content for Accordion 3",
    },
    {
      id: 4,
      title: "What happens if documents are rejected?",
      content: "Content for Accordion 4",
    },
    {
      id: 5,
      title: "How do I access the admin dashboard?",
      content:
        "Login using your staff credentials provided by the ICT unit or OCS system admin.",
    },
    {
      id: 6,
      title: "What can I do as an admin?",
      content: "Content for Accordion 6",
    },
    {
      id: 7,
      title: "Can multiple admins access the system?",
      content: "Content for Accordion 7",
    },
    {
      id: 8,
      title: "How secure is the system?",
      content: "Content for Accordion 8",
    },
  ];
    ...
    <div className="px-[30px] lg:px-[50px] xl:px-[137px] relative max-w-[1500px] w-full">
      ...
      <div className="xl:py-[70px] w-full py-[50px] relative items-center flex flex-col gap-[18px]">
        ...
        <p className="text-[12px] text-[#000000B2] xl:text-[15px] text-center max-w-[633px] font-[400] leading-[25px] w-full">
          Answers to common questions about using the OCS platform for both
        ...
        <div className="flex gap-[14px] mt-[26px] mx-auto xl:mx-0 items-center">
          ...
          <Link to="/how-it-works">
            {" "}
            <button className="text-black border cursor-pointer border-black text-[16px] w-[152px] h-[51px] flex items-center justify-center rounded-full">
          ...
          <div className="flex-1 space-y-4">
            ...
            {accordions.slice(0, 4).map((item) => (
              ...
              >
                ...
                >
                  <h1 className="font-medium text-[13px] md:text-[16px]">
                    {item.title}
                  </h1>
                ...
                >
                  <div className="overflow-hidden rounded-b-lg">
                    <div className="p-4 bg-white shadow-[inset_0_6px_8px_-6px_rgba(0,0,0,0.1)]">
                      <p className="text-[11px] text-[#000000B2]">
                        {" "}
                        {item.content}{" "}
                      </p>
                    </div>
